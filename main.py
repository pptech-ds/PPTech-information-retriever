...
#arg_dict['knowledges_csv'] = 'knowledges_test.csv'
...
arg_dict['model_path'] = 'PATH'
#arg_dict['output_dir'] = 'models/bert-base-quel-uncased-20191115-15h00'
#arg_dict['output_dir'] = 'models/bert-base-multilingual-uncased-20191022-23h23'
...
while(query!='exit'):
    ...
    my_es_dict = request_from_db(keywords_list.strip())

    # print('main:: my_es_dict {}'.format(my_es_dict))

    # # Requête le Reranker en lui passant l'ouput de l'IR et récupère les outputs finaux
    # my_bm25ranker_dict = bm25ranker(my_result_dict, keywords_list2.strip(), arg_dict['BM25_threshold'], arg_dict['tolerance'], arg_dict['BM25_nb_max_result'])
    # # print('my_bm25ranker_dict: {}'.format(my_bm25ranker_dict))
